...
// 상품 답변 등록
$(function(){
	$('div#content-area').on('click', 'button.reviewAddAnswer', function(){
		...
		inputTag1.classList.add('reviewIdInput');
		inputTag1.setAttribute('type', 'hidden');
		inputTag1.setAttribute('name', 'reviewId');
		inputTag1.value = reviewId;
...
// 상품 답변 수정 시작
$(function(){
	$('div#content-area').on('click', 'button.reviewUpdateAnswer', function(){
		...
		btnTag1.classList.add('reviewUpdateSubmitAnswer');
		...
		btnTag2.classList.add('reviewUpdateCancelAnswer');
	...
	// 수정 완료
	$('div#content-area').on('click', 'button.reviewUpdateSubmitAnswer', function(){
		const f = document.reviewAnswerForm;
	...
	// 수정 취소
	$('div#content-area').on('click', 'button.reviewUpdateCancelAnswer', function(){
		...
		let updateBtn = $(this).parent().find('button.reviewUpdateAnswer');
		let removeBtn = $(this).parent().find('button.reviewRemoveAnswer');
...
$(function(){
	// 상품 답변 삭제
	$('div#content-area').on('click', 'button.reviewRemoveAnswer', function(){
		...
		location.href = 'deleteReviewAnswer?reviewId=' + reviewId;
	});
})
...
$(function(){
	...
	$('div#content-area').on('click', 'button.deleteReview', function(){
		...
		location.href = 'deleteReview?reviewId=' + reviewId;
	});
});
