						...
						<div class="mt-3">
							...
							<table class="table table-bordered mb-1">
								...
								<tr>
									...
									<td width="180"><fmt:formatNumber value="${dto.savedMoney}"/></td>
								</tr>
...
$(function(){
	$('.btnDetailStateUpdateOk').click(function(){
		...
		const fn = function(data) {
			let reloadUrl = '${pageContext.request.contextPath}/admin/order/detailManage/${itemId}/${dto.orderDetailNum}?${query}';
