								...
								<tbody>
									<c:forEach var="dto" items="${listDetail}" varStatus="status">
										<tr valign="middle" id="orderDetail-list${dto.orderDetailNum}">
											<td align="center">${dto.orderDetailNum}</td>
											...
											<td align="center" class="${dto.detailState==3||dto.detailState==5?'text-line':''}"><fmt:formatNumber value="${dto.savedMoney}"/></td>
											<td align="center">
			...
			<div class="modal-body pt-3">
				<table class="table table-bordered">
					<tr valign="middle">
						...
						<td width="250">
							<p class="form-control-plaintext">${order.orderNum}</p>
						</td>
