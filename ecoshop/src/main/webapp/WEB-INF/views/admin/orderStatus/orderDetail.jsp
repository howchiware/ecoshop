                     ...
                     <table class="table order-detail-list">
                        ...
                        <tbody>
                           <c:forEach var="dto" items="${listDetail}" varStatus="status">
                              <tr valign="middle" id="orderDetail-list${dto.orderDetailId}">
                                 <td align="center">${dto.orderDetailId}</td>
                                 ...
                                 <td align="center" class="${dto.detailState==3||dto.detailState==5?'text-line':''}">
                                    <c:choose>
                                 ...
                                 <td align="center" class="${dto.detailState==3||dto.detailState==5?'text-line':''}">${dto.qty}</td>
                                 <td align="center" class="${dto.detailState==3||dto.detailState==5?'text-line':''}"><fmt:formatNumber value="${dto.productMoney}"/></td>
                                 <td align="center" class="${dto.detailState==3||dto.detailState==5?'text-line':''}"><fmt:formatNumber value="${dto.savedPoint}"/></td>
                                 <td align="center">
                                 ...
                                 <td align="center">
                                    <span class="orderDetailStatus-update" 
                                          ...
                                          data-orderDetailId="${dto.orderDetailId}"
                                          data-productCode="${dto.productCode}"
                                          data-optionCount="${dto.optionCount}"
                                          data-optionDetailNum="${dto.optionDetailNum}"
                                          data-optionDetailNum2="${dto.optionDetailNum2}"
                                          data-savedPoint="${dto.savedPoint}"
                                          data-qty="${dto.qty}"
            ...
            <div class="p-1 detailStateUpdate-form">
               <form name="detailStateForm" class="row justify-content-center">
                  ...
                  <div class="col-auto p-1">
                     ...
                     <input type="hidden" name="optionDetailNum">
                     <input type="hidden" name="optionDetailNum2">
                     <input type="hidden" name="qty">
                     <input type="hidden" name="productMoney">
                     <input type="hidden" name="savedPoint">
...
$(function(){
   $('.orderDetailStatus-update').on('click', function(){
      ...
      let usedPoint = $EL.attr('data-usedPoint');
      let memberId = $EL.attr('data-memberId');
      let orderDate = $EL.attr('data-orderDate');
      
      // 상품 상세 정보 -
      let orderDetailId = $EL.attr('data-orderDetailId');
      let productCode = $EL.attr('data-productCode');
      let optionCount = $EL.attr('data-optionCount');
      let optionDetailNum = $EL.attr('data-optionDetailNum');
      let optionDetailNum2 = $EL.attr('data-optionDetailNum2');
      let savedPoint = $EL.attr('data-savedPoint');
      ...
      f.optionDetailNum.value = optionDetailNum;
      f.optionDetailNum2.value = optionDetailNum2;
      f.qty.value = qty;
      f.productMoney.value = productMoney;
      f.payment.value = payment;
      f.savedPoint.value = savedPoint;
   ...
   function listDetailState() {
      ...
      const f = document.detailStateForm;
      let orderDetailId = f.orderDetailId.value;
   ...
   $('.btnDetailStateUpdateOk').click(function(){
      ...
      let preDetailState = $('#orderDetail-list' + orderDetailId).find('td').eq(9).find('span').attr('data-detailState');
      ...
      const fn = function(data) {
         if(data.state === 'true') {
            ...
            $('#orderDetail-list' + orderDetailId).find('td').eq(8).html(changeStateInfo);
            $('#orderDetail-list' + orderDetailId).find('td').eq(9).find('span').attr('data-detailState', detailState);
