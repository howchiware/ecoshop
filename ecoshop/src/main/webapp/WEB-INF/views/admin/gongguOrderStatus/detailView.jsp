...
$(function(){
	$('.btnDetailStateUpdateOk').click(function(){
		...
		const fn = function(data) {
			let reloadUrl = '${pageContext.request.contextPath}/admin/gongguOrder/detailManage/${itemId}/${dto.gongguOrderDetailId}?${query}';
...
function listDetailState() {
	...
	let gongguOrderDetailId = '${dto.gongguOrderDetailId}';
