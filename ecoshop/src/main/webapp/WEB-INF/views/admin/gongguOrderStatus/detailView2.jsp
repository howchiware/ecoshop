					...
					<div class="col-lg-12 p-2 m-2" data-aos="fade-up" data-aos-delay="200">
						...
						<div class="mt-3">
							...
							<table class="table table-bordered mb-1">
								...
								<tr>
									...
									<td width="180">${dto.member_id}</td>
									<td class="table-light" width="140">아이디</td>
									<td width="180">${dto.login_id}</td>
								</tr>
							...
							<div class="mt-3">
								...
								<table class="table table-bordered mb-1">
									<c:forEach var="vo" items="${listBuy}">
										<c:if test="${dto.gongguOrderDetailId != vo.gongguOrderDetailId}">
											<tr>
												<td class="table-light" width="140">상품명</td>
												<td colspan="3">
													${vo.gongguProductName}
													&nbsp;수량 : ${vo.qty}
												</td>
						...
						<table class="table table-borderless">
							<tr>
								...
								<td class="text-end">
									<button type="button" class="btn-default" onclick="location.href='${pageContext.request.contextPath}/admin/gongguOrder/detailManage/${itemId}?${query}';">리스트</button>
								</td>
							</tr>
						</table>
				...
				<form name="detailStateForm" class="justify-content-center detailState-form">
					...
					<div class="row">
						<div class="col p-1 text-end">
							<input type="hidden" name="orderNum" value="${dto.orderId}">
							<input type="hidden" name="orderDetailNum" value="${dto.gongguOrderDetailId}">
							<input type="hidden" name="productNum" value="${dto.gongguProductId}">
							<input type="hidden" name="payment" value="${dto.payment}">
							<input type="hidden" name="member_id" value="${dto.memberId}">
...
$(function(){
	$('.btnDetailStateUpdateOk').click(function(){
		...
		const fn = function(data) {
			let reloadUrl = '${pageContext.request.contextPath}/admin/gongguOrder/detailManage/${itemId}/${dto.orderDetailNum}?${query}';
...
function listDetailState() {
	...
	let orderDetailNum = '${dto.orderDetailNum}';
