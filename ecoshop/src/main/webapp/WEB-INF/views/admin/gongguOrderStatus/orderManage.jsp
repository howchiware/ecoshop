...
.right-PANEL .page-navigation ul, .right-PANEL .page-navigation .paginate
	{
	margin: 0;
}
									...
									<tbody>
										<c:forEach var="dto" items="${list}" varStatus="status">
											<tr class="hover-cursor"
												onclick="location.href='${pageContext.request.contextPath}/admin/gongguOrder/orderManage/${itemId}/${dto.orderId}?${query}';">
												<td>${dto.orderId}</td>
								...
								<div class="row mt-3">
									<div class="col-md-12 text-center">
										<form name="searchForm"
											...
											<select name="schType"
												...
												<c:if test="${itemId==110}">
													<option value="invoiceNumber"
														${schType=="invoiceNumber"?"selected":""}>송장번호</option>
												</c:if>
											...
											<button type="button" class="btn-default"
												onclick="location.href='${pageContext.request.contextPath}/admin/gongguOrder/orderManage/${itemId}';"
												title="새로고침">
