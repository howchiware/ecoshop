				...
				<div>
					<div class="row gy-4 m-0">
						<div class="col-lg-12 p-2 m-2" data-aos="fade-up" data-aos-delay="200">
							...
							<div class="row mt-3">
								<div class="col-md-3">
									<button type="button" class="btn-default" onclick="location.href='${pageContext.request.contextPath}/admin/gongguOrder/detailManage/${itemId}';" title="새로고침"><i class="bi bi-arrow-clockwise"></i></button>
								</div>
								<div class="col-md-6 text-center">
									<form name="searchForm" class="form-search">
										<select name="schType">
											...
											<option value="productName" ${schType=="gongguProductName"?"selected":""}>상품이름</option>
										</select>
