		...
		<div class="right-PANEL">
			...
			<div class="outside review-manage">
				<div class="review-manage-nav">
					<button class="nav-tab active" data-url="/admin/products/reviewList" onclick="showReviewTab(this)">상품리뷰</button>
					<button class="nav-tab" data-url="/admin/products/inquiryList" onclick="showReviewTab(this)">상품문의</button>
				</div>
