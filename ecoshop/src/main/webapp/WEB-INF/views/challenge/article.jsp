...
<head>
  ...
  <style>
    ...
    .btn-grad { border:none; color:#fff; font-weight:800; padding:12px 16px; border-radius:10px; background:linear-gradient(90deg,#5e9cff,#8b5dff); }
    ...
    <section class="panel mb-4">
      ...
      <div class="d-flex justify-content-between align-items-center cta-bar">
        ...
        <c:choose>
          ...
          <c:otherwise>
            <button class="btn-grad" disabled>스페셜 챌린지 참여하기</button>
          </c:otherwise>
        </c:choose>
      </div>
    </section>
