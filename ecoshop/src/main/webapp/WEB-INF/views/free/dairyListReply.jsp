...
<table class="table table-borderless">
	<c:forEach var="vo" items="${listReply}">
		...
		<tr>
			<td>
				<button type="button" class="btn-default btnReplyAnswerLayout" data-replyNum="${vo.replyNum}">답글 <span id="answerCount${vo.replyNum}">${vo.answerCount}</span></button>
			</td>
			<td align="right" data-userLiked="${vo.userReplyLiked}">
				<button type="button" class="btn-default btnSendReplyLike" data-replyNum="${vo.replyNum}" data-replyLike="1" title="좋아요" ><i class="bi bi-hand-thumbs-up" style="${vo.userReplyLiked == 1 ? 'color:red;':''}"></i> <span>${vo.likeCount}</span></button>
				<button type="button" class="btn-default btnSendReplyLike" data-replyNum="${vo.replyNum}" data-replyLike="0" title="싫어요" ><i class="bi bi-hand-thumbs-down" style="${vo.userReplyLiked == 0 ? 'color:red;':''}"></i> <span>${vo.disLikeCount}</span></button>	        
			</td>
		</tr>
